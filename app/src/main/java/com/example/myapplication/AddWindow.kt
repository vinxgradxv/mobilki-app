...
@Composable
fun AddWindow(navController: NavHostController, token: String, clientId: String, facilityId: String) {
    ...
    Column(modifier = Modifier
        ...
        // Welcome message
        Text(text = "Новое окно", fontSize = 40.sp, color = Color.Black
        )
        ...
        OutlinedButton(onClick = {
            var response: CreateWindowResponse
            scope.launch {
                try {
                    response = apiRepo.sendCreateWindow(CreateWindowRequest(windowName.value, facilityId), token)
